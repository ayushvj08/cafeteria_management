class MenuItemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @menu_item.save
        format.html { redirect_to @menu_item, notice: "A New Menu Item is Created." }
    ...
    # session[:menu_categories.name] = nil
  end
  ...
  def update
    respond_to do |format|
      if @menu_item.update(menu_item_params)
        format.html { redirect_to @menu_item, notice: "successfully updated Menu item." }
